...
class SetCardK extends StatefulWidget {
  @override
  _SetCardKState createState() => _SetCardKState();
}

class _SetCardKState extends State<SetCardK> {
                        ...
                        child: ListTile(
                          onTap: () {
                            ...
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => SetCardJ(id: ktg.id, Katagori: ktg.katagori),
                                ));
                          },
