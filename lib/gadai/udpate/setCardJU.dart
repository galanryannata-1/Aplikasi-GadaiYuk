...
import 'package:gadaiyuk_terbaru/gadai/udpate/update.dart';




class SetCardJU extends StatefulWidget {
  final String id;
  final String Katagori;
  const SetCardJU({Key? key, required this.id, required this.Katagori}) : super(key: key);
  @override
  State<StatefulWidget> createState() => _SetCardJUState();
}

class _SetCardJUState extends State<SetCardJU> {
   String id = '';
   String Katagori = '';
                        ...
                        child: ListTile(
                          onTap: () {
                            ...
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => Update(id: id, Katagori: Katagori, jenis: jns.nama, idjns:jns.idJNS),
                                ));
                          },
                          title: Text('${jns.nama}'),
